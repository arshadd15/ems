...
const AllTask = () => {
  ...
  return (
    ...
    >
      <div className="min-w-[600px] flex flex-wrap lg:flex-nowrap justify-between items-center mb-2 py-3 p-1 lg:px-4 rounded-lg text-white bg-fuchsia-800">
        <h2 className="font-medium text-sm lg:text-lg w-1/2 sm:w-1/3 lg:w-1/5">
          Employee Name
        </h2>
        <h2 className="font-medium text-sm lg:text-lg w-1/2 sm:w-1/6 lg:w-1/5">
          New Task
        </h2>
        <h2 className="font-medium text-sm lg:text-lg w-1/2 sm:w-1/6 lg:w-1/5">
          Active Task
        ...
        <h2 className="font-medium text-sm lg:text-lg w-full sm:w-1/6 lg:w-0">
          Failed
        </h2>
      </div>
      <div>
