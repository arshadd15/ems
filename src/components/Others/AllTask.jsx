  ...
  return (
    ...
    >
      <div className="bg-fuchsia-800 flex justify-between items-center mb-2 py-3 px-4 rounded-lg text-white">
        <h2 className="font-medium text-sm lg:text-lg w-1/5">Employee Name</h2>
        <h2 className="font-medium text-sm lg:text-lg w-1/5">New Task</h2>
        <h2 className="font-medium text-sm lg:text-lg w-1/5">Active Task</h2>
        <h2 className="font-medium text-sm lg:text-lg w-1/5">Completed Task</h2>
      ...
      <div>
        {userData?.employees?.map((elem, idx) => (
          <div
            key={idx}
            className="border border-orange-400 bg-white/10 flex justify-between items-center mb-2 py-3 px-1 lg:px-4 rounded-lg transition-all duration-200 hover:scale-[102%] hover:bg-white/20 hover:shadow-md hover:shadow-orange-400/50"
          >
